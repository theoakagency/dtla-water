...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    county: 'Los Angeles County',
    phone: '(213) 371-4500',
    heroDesc: 'Water delivery for Vernon and the surrounding industrial district — warehouses, manufacturing, and distribution facilities.',
    neighborhoods: ['Vernon', 'South LA industrial corridor'],
    zips: ['90058', '90001', '90011'],
    customerTypes: ['Industrial Facilities', 'Warehouses & Distribution', 'Offices', 'Manufacturing'],
    testimonial: PLACEHOLDER_TESTIMONIAL,
    mapQuery: 'Vernon+CA',
  },
  {
