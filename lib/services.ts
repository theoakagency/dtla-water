...
export const services: ServiceData[] = [
  {
    ...
    heroDesc: 'DTLA Water delivers premium purified and alkaline water to offices across Downtown LA and Greater Los Angeles. Flexible scheduling, no contracts, and a dedicated account for your business.',
    painPoints: [
    ...
    testimonial: {
      quote: 'PLACEHOLDER — replace with a real DTLA Water customer testimonial for this service before launch.',
      name: 'Add customer name',
      role: 'Add role, Downtown LA',
      initials: '—',
    },
    faq: [
    ...
    metaTitle: 'Office Water Delivery | DTLA Water — Downtown LA',
    metaDesc: 'Reliable water delivery for offices and businesses across Downtown LA and Greater Los Angeles. Purified and alkaline water, flexible scheduling, volume discounts.',
  },
  {
    slug: 'restaurant',
    name: 'Restaurant',
    ...
    heroDesc: 'The quality of your water directly affects the taste of everything you serve — from coffee and tea to sauces and soups. DTLA Water delivers consistently pure, great-tasting water to restaurants across Downtown LA and Greater Los Angeles.',
    painPoints: [
    ...
    metaTitle: 'Restaurant Water Delivery | DTLA Water — Downtown LA',
    metaDesc: 'Premium water delivery for restaurants and food service businesses in Downtown LA and Greater Los Angeles. NSF certified purified water for cooking, alkaline water for table service.',
  },
  {
    slug: 'home',
    name: 'Home',
    ...
    heroDesc: 'Stop buying single-use plastic bottles from the grocery store. DTLA Water delivers fresh purified and alkaline water directly to your home on a schedule that works for your family.',
    painPoints: [
    ...
    metaTitle: 'Home Water Delivery | DTLA Water — Downtown LA',
    metaDesc: 'Fresh purified and alkaline water delivered to your home in Downtown LA and Greater Los Angeles. No contracts, flexible scheduling.',
  },
  {
    slug: 'gym',
    name: 'Gym & Fitness',
    ...
    heroDesc: 'Your members push hard. Give them water that works as hard as they do. DTLA Water delivers pH 9.5 alkaline water and purified water to gyms, CrossFit boxes, yoga studios, and fitness centers across Downtown LA and Greater Los Angeles.',
    painPoints: [
    ...
    faq: [
      ...
      { q: 'Can we put your branding or signage near the cooler?', a: 'We can provide DTLA Water branded materials for display near coolers. Ask us when you sign up.' },
    ...
    metaTitle: 'Gym & Fitness Water Delivery | DTLA Water — Downtown LA',
    metaDesc: 'Premium alkaline and purified water delivery for gyms, CrossFit boxes, and fitness studios in Downtown LA and Greater Los Angeles. pH 9.5 alkaline water for serious athletes.',
  },
  {
    slug: 'catering',
    ...
    heroDesc: 'From film and TV production craft services to wedding catering and corporate events, DTLA Water delivers premium purified and alkaline water throughout Downtown LA and Greater Los Angeles.',
    painPoints: [
    ...
    benefits: [
      ...
      'Serving Downtown LA, Hollywood, Culver City, and Burbank film country',
      'Empty bottle pickup included',
    ],
    ...
    faq: [
      ...
      { q: 'Do you deliver to film locations and event venues?', a: 'Yes. We deliver throughout Downtown LA and Greater Los Angeles — including production facilities, studio lots, and event spaces.' },
    ...
    metaTitle: 'Catering & Craft Services Water Delivery | DTLA Water',
    metaDesc: 'Premium water delivery for film production craft services, catering, and events in Downtown LA and Greater Los Angeles. Purified and alkaline water for cast and crew.',
  },
]
