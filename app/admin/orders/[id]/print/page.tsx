...
export default function PrintOrderPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F8FB] print:bg-white">

      {/* Screen-only toolbar */}
      <div className="print:hidden sticky top-0 z-10 bg-[#1B3A6B] text-white px-6 py-3 flex items-center justify-between shadow-lg">
        <button
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#29ABE2] hover:bg-[#2a2a2a] text-[#1B3A6B] px-5 py-2 rounded-lg text-sm font-bold transition-colors"
        >
          <Printer size={15} />
          Print
        </button>
      ...
      <div className="max-w-2xl mx-auto px-8 py-10 print:px-0 print:py-0 print:max-w-none">
        ...
        {/* Header */}
        <div className="flex items-start justify-between mb-8 pb-6 border-b-2 border-[#1B3A6B] print:border-[#1B3A6B]">
          <div>
            <Image
              src="/dtla-water-logo.png"
              alt="DTLA Water"
              width={117}
              height={54}
          ...
          <div className="text-right">
            <p className="text-3xl font-bold text-[#1B3A6B]">#{order.id}</p>
            ...
            <span className={`inline-block mt-2 text-xs font-bold uppercase tracking-wide px-3 py-1 rounded-full border ${
              order.status === 'new'       ? 'bg-[#F5F8FB] text-[#1B3A6B] border-[#29ABE2]/40' :
        ...
        <section className="mb-7">
          <h2 className="text-xs font-bold uppercase tracking-widest text-[#29ABE2] mb-3">Customer Information</h2>
        ...
        {/* Order details */}
        <section className="mb-7">
          <h2 className="text-xs font-bold uppercase tracking-widest text-[#29ABE2] mb-3">Order Details</h2>
          <div className="bg-white rounded-xl border border-[#d0e4ef] p-5 grid grid-cols-2 gap-x-8 gap-y-3 print:rounded-none print:border print:border-gray-300">
        ...
        <section className="mb-10">
          <h2 className="text-xs font-bold uppercase tracking-widest text-[#29ABE2] mb-3">Internal Notes</h2>
          <div className="bg-white rounded-xl border border-[#d0e4ef] p-5 min-h-[80px] print:rounded-none print:border print:border-gray-300">
            {order.notes
              ? <p className="text-sm text-[#1A1A1A] whitespace-pre-wrap leading-relaxed">{order.notes}</p>
        ...
        <section className="mb-10">
          <h2 className="text-xs font-bold uppercase tracking-widest text-[#29ABE2] mb-3">Delivery</h2>
          <div className="bg-white rounded-xl border border-[#d0e4ef] p-5 grid grid-cols-2 gap-x-8 gap-y-6 print:rounded-none print:border print:border-gray-300">
            <div>
              ...
              <div className="border-b border-[#1B3A6B] h-px" />
...
function Field({ label, value }: { label: string; value: string }) {
  return (
    <div>
      ...
      <p className="text-sm text-[#1A1A1A] font-semibold">{value}</p>
    </div>
  )
}
