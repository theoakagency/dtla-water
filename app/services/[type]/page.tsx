      ...
      <main>
        ...
        <section className="min-h-[60vh] bg-gradient-to-br from-[#12233F] via-[#1B3A6B] to-[#2A5A96] flex items-center pt-16 px-6 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto w-full py-20">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
              {service.headline}
            </h1>
            <p className="text-xl text-[#29ABE2] font-medium mb-5">{service.subheadline}</p>
            <p className="text-lg text-white/65 max-w-2xl leading-relaxed mb-10">{service.heroDesc}</p>

            <div className="flex flex-wrap gap-4">
              <a href="/#order" className="bg-[#111111] text-white px-8 py-4 rounded-lg font-bold hover:bg-[#2a2a2a] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(0,201,228,0.35)]">
                Start My Delivery →
              </a>
        ...
        <section className="py-20 px-6 bg-[#F5F8FB]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-xs font-bold tracking-[0.12em] uppercase text-[#29ABE2] mb-3">We Get It</p>
              <h2 className="text-4xl font-bold text-[#1B3A6B]" style={{ fontFamily: 'var(--font-heading)' }}>
                Sound Familiar?
              </h2>
            </div>
              ...
              {service.painPoints.map((point) => {
                ...
                return (
                  <div key={point.title} className="bg-white rounded-2xl p-6 border border-[#d0e4ef]">
                    ...
                    <h3 className="font-bold text-[#1B3A6B] mb-2 text-sm" style={{ fontFamily: 'var(--font-heading)' }}>
                      {point.title}
                    </h3>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            {/* Benefits */}
            <div>
              <p className="text-xs font-bold tracking-[0.12em] uppercase text-[#29ABE2] mb-4">What You Get</p>
              <h2 className="text-4xl font-bold text-[#1B3A6B] mb-8 leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                Everything Your {service.name} Needs
              </h2>
              <ul className="space-y-3">
                {service.benefits.map((benefit) => (
                  <li key={benefit} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#F5F8FB] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Check size={11} className="text-[#29ABE2]" />
                    </div>
                    <span className="text-[#1A1A1A] text-sm leading-relaxed">{benefit}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* Typical order card */}
            <div>
              <p className="text-xs font-bold tracking-[0.12em] uppercase text-[#29ABE2] mb-4">Example Setup</p>
              <h2 className="text-4xl font-bold text-[#1B3A6B] mb-8 leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                Typical Order for a {service.name}
              </h2>
              <div className="bg-gradient-to-br from-[#1B3A6B] to-[#2A5A96] rounded-2xl p-8 text-white">
              ...
              <a
                href="/#order"
                className="mt-5 w-full block text-center bg-[#111111] text-white py-4 rounded-xl font-bold text-base hover:bg-[#2a2a2a] transition-all hover:-translate-y-0.5"
              >
        ...
        <section className="py-20 px-6 bg-[#1B3A6B]">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="w-12 h-12 rounded-full bg-[#111111] text-white font-bold flex items-center justify-center text-sm">
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              <p className="text-xs font-bold tracking-[0.12em] uppercase text-[#29ABE2] mb-3">Questions</p>
              <h2 className="text-4xl font-bold text-[#1B3A6B]" style={{ fontFamily: 'var(--font-heading)' }}>
        ...
        {/* ── Other Services ── */}
        <section className="py-16 px-6 bg-[#F5F8FB]">
          <div className="max-w-6xl mx-auto">
            <h3 className="text-xl font-bold text-[#1B3A6B] mb-8 text-center" style={{ fontFamily: 'var(--font-heading)' }}>
              We Also Serve
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {otherServices.map((s) => (
                <Link
                  ...
                  className="bg-white border-2 border-[#d0e4ef] rounded-2xl p-6 hover:border-[#29ABE2] hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(21,101,192,0.1)] transition-all group"
                >
                  <h4 className="font-bold text-[#1B3A6B] mb-2" style={{ fontFamily: 'var(--font-heading)' }}>{s.name}</h4>
