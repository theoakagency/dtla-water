      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          <div style="background:#1B3A6B;padding:24px 32px;">
            ...
            <p style="color:#29ABE2;margin:6px 0 0;font-size:14px;">dtlawater.com</p>
          </div>
          <div style="padding:32px;background:#F5F8FB;">
            <table style="width:100%;border-collapse:collapse;background:#fff;border-radius:8px;overflow:hidden;">
              <tr style="background:#F5F8FB;">
                <td colspan="2" style="padding:12px 16px;font-weight:bold;color:#1B3A6B;font-size:13px;text-transform:uppercase;letter-spacing:.05em;">Sender Details</td>
              </tr>
              <tr>
              ...
              <tr style="background:#fafafa;">
                ...
                <td style="padding:10px 16px;font-size:14px;">
                  <a href="mailto:${email}" style="color:#29ABE2;">${email}</a>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 16px;color:#5a7080;font-size:14px;">Phone</td>
                <td style="padding:10px 16px;font-size:14px;">
                  ${phone ? `<a href="tel:${phone}" style="color:#29ABE2;">${phone}</a>` : '<span style="color:#aaa;">Not provided</span>'}
                </td>
              </tr>
              <tr style="background:#fafafa;">
              ...
              <tr style="background:#F5F8FB;">
                <td colspan="2" style="padding:12px 16px;font-weight:bold;color:#1B3A6B;font-size:13px;text-transform:uppercase;letter-spacing:.05em;">Message</td>
              </tr>
              <tr>
                <td colspan="2" style="padding:16px;font-size:14px;line-height:1.7;color:#1A1A1A;">
                  ${message.replace(/\n/g, '<br/>')}
                </td>
              </tr>
            </table>
            <div style="margin-top:20px;text-align:center;">
              <a href="mailto:${email}" style="display:inline-block;background:#29ABE2;color:#fff;padding:12px 24px;border-radius:8px;font-weight:700;text-decoration:none;font-size:14px;">
                Reply to ${name} →
              </a>
            </div>
          </div>
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          <div style="background:#1B3A6B;padding:24px 32px;text-align:center;">
            ...
            <p style="color:#29ABE2;margin:8px 0 0;font-size:14px;">We'll be in touch within 1 business day</p>
          </div>
          <div style="padding:32px;">
            ...
            <div style="text-align:center;margin:24px 0;">
              <a href="tel:+12133714500" style="display:inline-block;background:#1B3A6B;color:#fff;padding:14px 28px;border-radius:8px;font-weight:700;text-decoration:none;font-size:16px;">
                (213) 371-4500
              </a>
            </div>
            <div style="background:#F5F8FB;border-radius:10px;padding:16px 20px;margin-top:16px;">
              <p style="margin:0;font-size:13px;color:#5a7080;"><strong style="color:#1B3A6B;">Your message:</strong><br/>${message.replace(/\n/g, '<br/>')}</p>
            </div>
            <p style="color:#5a7080;font-size:13px;margin-top:20px;line-height:1.6;">
              — The DTLA Water Team<br/>
